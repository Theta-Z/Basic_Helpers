...
namespace FlyFF_Helper.Helpers
{
    ...
    public class WinAPI
    {
        ...
        /// <summary>
        ///  Do a Left click #numClicks# times.
        /// </summary>
        /// <param name="numClicks">Number of time to click</param>
        ...
        /// <summary>
        ///  Hold down / let up Mouse_RightClick
        /// </summary>
        /// <param name="status">The status for up or down click.</param>
